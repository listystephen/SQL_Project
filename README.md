...
Sql queries used for each questions mentioned in this file: Library_project.sql
Screenshot of each query execution pasted in the word file : Library_project.docx
Screenshot of each query execution in PDF version : Library_project.pdf
